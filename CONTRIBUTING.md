...
```
git clone git://github.com/xively/xively-imp.git
```
...
```
git remote add upstream https://github.com/xively/xively-imp
git fetch upstream
...
```
git remote add mine git@github.com:<your user name>/xively-imp.git
git push mine new_feature_branch
```
Then:
- Navigate to the  repository you just pushed to (e.g. https://github.com/your-user-name/xively-imp)
- Click "Pull Request"
